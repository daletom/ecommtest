          ...
          get: function get(obj2, apiCall) {
            return function call() {
              ...
              function () {
                ...
                /*#__PURE__*/
                regeneratorRuntime.mark(function _callee2(schema) {
                  var singularized, sub, methodNames, identityRegexp, link, lastUrlId, url, body, queryString, options, deserializeResponse, deserialize, serializeRequest, allPages, request;
                  return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        case 0:
                          singularized = (0, _humps.decamelize)(_pluralize["default"].singular(namespace));
                          sub = schema.properties[singularized];
                        ...
                        case 4:
                          ...
                          identityRegexp = /\{\(.*?definitions%2F(.*?)%2Fdefinitions%2Fidentity\)}/g;
                          link = sub.links.find(function (l) {
